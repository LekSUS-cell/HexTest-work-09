...
public class HexcellsUI extends JPanel {
    ...
    public HexcellsUI(JFrame frame, JPanel container, CardLayout cardLayout, Board.Level level) {
        ...
        // Счётчик мин
        mineCountLabel = new JLabel("Мины: 0");
        ...
        hintButton.addActionListener(e -> {
            ...
            if (hint != null) {
                ...
                JOptionPane.showMessageDialog(frame, "Нет детерминированных подсказок! Нужно угадать.");
            }
        });
    ...
    private void showGameOverDialog() {
        ...
        restartButton.addActionListener(e -> {
            ...
            newGame.setName(level.name() + "Game");
            container.add(newGame, level.name() + "Game");
            cardLayout.show(container, level.name() + "Game");
            frame.setSize(size);
